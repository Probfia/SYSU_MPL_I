...
\beq
g_{\rm DPPH} = \frac{fh}{\mu_B B_0} = \frac{9.390 \times 10^{13} \unit{Hz} \times 4.1357\times 10^{-21} \unit{MeV\cdot s}}{5.7884 \times 10^{-11} \unit{MeV/Gs} \times 3344.85\unit{(Gs)} }= 2.0058
\eeq
由误差传递公式
\beq
